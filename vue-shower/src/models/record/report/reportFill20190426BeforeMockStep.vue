    ...
    <div class="fill-root">
      ...
      <div class="fill-context">
        ...
        <div v-if="isView!='Y'" class="fill-context-options">
          ...
          <el-button v-if="isView!='Y'" @click="saveContext" type="info">校验</el-button>
          <el-button v-if="isView!='Y'" @click="saveContext" type="info">提交</el-button>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      saveContext(){//保存
        if(this.unitEntities!=null){
          this.unitEntities.forEach(unitEntity=>{
            const unitId = unitEntity.unit_id
            this.selectActiveStep(unitId,false)
