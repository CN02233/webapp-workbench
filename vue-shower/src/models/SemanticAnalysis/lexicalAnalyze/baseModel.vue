  ...
  <WorkMain :headerItems="['NLP基础','词法分析']">
    <el-row>
      ...
      <el-col :offset="1" :span="11">
        ...
        <el-col>
          <el-col :span="20">
            <el-input placeholder="请输入内容" v-model="uploadFilePath" class="input-with-select">
