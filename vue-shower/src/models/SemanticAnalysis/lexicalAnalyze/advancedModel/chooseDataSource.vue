    ...
    methods: {
      ...
      nextStep(responseData){
        if(responseData.status!='0'){
          ...
          this.$emit('nextStep',responseData.uuid,{"result":responseData.result,"unknowWord":responseData.unknown});
        }
      }
    }
  }
