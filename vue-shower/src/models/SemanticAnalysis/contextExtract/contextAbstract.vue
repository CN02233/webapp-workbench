<template>
  <WorkMain :headerItems="['NLP应用','内容摘要']">
    <el-row>
      <el-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      nextStep(responseData){
        ...
        this.$router.push({name:"contextAbstractResult",params:{"resultData":responseData.result}})
      }
    }
  }
</script>
