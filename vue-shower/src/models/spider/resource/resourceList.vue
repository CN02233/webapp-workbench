  ...
  <WorkMain :headerItems="['资源管理','离线页面查看']">
    <el-row class="search-row" :gutter="20">
      <el-col class="align-left" :span="17">
        ...
        <el-input placeholder="采集开始时间" v-model="job_start_time" style="width:180px" ></el-input>
        <el-input placeholder="采集结束时间" v-model="job_end_time" style="width:180px" ></el-input>
        <el-input placeholder="采集名称" v-model="job_name" style="width:180px" ></el-input>
