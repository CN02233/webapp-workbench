...
public interface IReportDefinedUnitMultDimDao {
    ...
    @Select("<script>select distinct a.*,aa.colum_name,aa.colum_name_cn,aa.colum_point,aa.colum_desc,'1' colum_meta_type from report_defined_unit_multdim a left join report_defined_unit_multdim_col aa on a.colum_id=aa.colum_id where a.unit_id=#{unitId}" +
