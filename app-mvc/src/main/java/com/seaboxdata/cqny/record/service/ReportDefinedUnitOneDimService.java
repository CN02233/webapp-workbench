...
public interface ReportDefinedUnitOneDimService {
    ...
    List<CopyReportDefinedTmp> copyOneDims(Map<Integer, UnitDefined> fromAndToUnits);

    List<CopyReportDefinedTmp> copyDymDims(Map<Integer, UnitDefined> fromAndToUnits);
}
