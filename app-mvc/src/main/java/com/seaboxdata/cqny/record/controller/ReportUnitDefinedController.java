...
public class ReportUnitDefinedController {
    ...
    public JsonResult reportUnitDefinedList(Integer currPage,Integer pageSize ,Integer reportDefinedId  ){
        PageResult definedUnitpageLIst = reportDefinedUnitService.pagerReportUnitDefinedList(currPage,pageSize,reportDefinedId);
        JsonResult jsonResult = JsonSupport.makeJsonpResult(JsonResult.RESULT.SUCCESS, "获取欧成功", null,definedUnitpageLIst);
        return jsonResult;
    }
